...
{
__main:
  %".2" = getelementptr inbounds [4 x i8], [4 x i8]* @"__string_1", i32 0, i32 0
  ...
  store i8 %".7", i8* %".5"
  %".9" = load i8, i8* %".5"
  %".10" = getelementptr inbounds [4 x i8], [4 x i8]* @"__string_2", i32 0, i32 0
  %".11" = getelementptr inbounds [14 x i8], [14 x i8]* @"__string_0", i32 0, i32 0
  %".12" = call i32 (i8*, ...) @"printf"(i8* %".10", i8* %".11")
  ret i32 0
}

@"__string_1" = internal global [4 x i8] c"%s\0a\00"
